...
import { ConnectionConstructor } from '../functions/wordFunc.jsx';


const Grid = ({charSetArr, charSequenceArr, wordsList}) => {
    ...
    useEffect(() => {
        ...
        let confirmedConnection = ConnectionConstructor(wordsList).map((char, index) => {
            return charSetArr.indexOf(char)
        });
    ...
    }, [GridAttribute, hasPainted, charSequenceArr, wordsList])
